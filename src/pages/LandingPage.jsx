...
const LandingPage = () => {
  ...
  return (
    ...
    style={{
      ...
      backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(216, 180, 254, 0.5) 0%, rgba(225, 240, 255, 0) 70%)',
    ...
    >
      ...
      <nav className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
        <div className="bg-blue-400/40 backdrop-blur-3xl border border-white/40 px-8 py-3 rounded-full flex items-center justify-between w-full max-w-5xl shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <button className="bg-[#1F2A44] text-white px-6 py-2 rounded-full text-sm font-semibold hover:bg-black transition">Daftar</button>
            <button className="bg-white/60 text-[#1F2A44] px-6 py-2 rounded-full text-sm font-semibold hover:bg-white transition border border-white/20">Masuk</button>
          </div>
        </div>
      </nav>
      ...
      <section id="home" className="pt-30 pb-20 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between min-h-screen">
        <div className="md:w-1/2 pt-30">
          ...
          <div className="flex flex-wrap gap-4">
            <button className="bg-[#1F2A44] text-white px-8 py-2.5 rounded-2xl font-sarabun text-lg flex items-center gap-2 hover:scale-105 transition shadow-lg ml-5">
              Mulai Sekarang <span>→</span>
            </button>
            <button className="bg-white/40 text-[#1F2A44] px-8 py-2.5 rounded-2xl font-sarabun text-lg hover:bg-white/60 transition border border-white/20 ml-5">
              Sudah Punya Akun
            </button>
          </div>
        </div>
      ...
      {/* 3. FEATURES SECTION */}
      <section id="fitur" className="py-24 px-6 max-w-7xl mx-auto text-center">
      ...
      {/* 4. CTA SECTION */}
      <section id="tentang" className="py-32 px-6 flex justify-center">
      ...
      {/* 5. FOOTER */}
      <footer className="py-10 text-center text-[#1F2A44] font-medium opacity-70">
