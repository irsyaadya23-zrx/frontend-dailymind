  ...
  return (
    ...
    <div className="w-full px-4 py-2 sm:p-6 md:p-8 lg:p-10">
      ...
      <div className="bg-white rounded-[2rem] p-10 shadow-sm border border-slate-100 text-center">
        ...
        <h3 className="text-2xl font-bold text-slate-700 mb-10">
          How Your Mood Today?
        </h3>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {moodButtons.map((mood) => {
            ...
            let btnClasses =
              "flex flex-col items-center justify-center p-8 rounded-3xl transition-all duration-300 group ";
            ...
            if (isAnsweredToday) {
              ...
              if (isSelected) {
                ...
                btnClasses +=
                  "bg-[#DEDEDE] border-2 border-transparent cursor-not-allowed opacity-70";
              ...
              iconClasses +=
                "text-[#000000]/30 transform group-hover:rotate-12";
      ...
      <div className="mt-10 bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100">
        ...
        <h3 className="font-bold text-2xl text-slate-700 mb-4 px-2">
          Riwayat Mood
        </h3>
        ...
        <div className="border-t border-slate-50 pt-4 px-2">
          {historyData.length > 0 ? (
            ...
            <p className="text-slate-400 text-sm italic">
              Belum ada data mood 7 hari terakhir.
            </p>
          )}
        </div>
      </div>
